...
The most common preparations for writing and submitting an RFC include talking the idea over on [TBD], discussing the topic on our [Github Discussions](https://github.com/fairDataSociety/fds-rfcs/discussions), and occasionally posting "pre-RFCs" one of the channels. 
